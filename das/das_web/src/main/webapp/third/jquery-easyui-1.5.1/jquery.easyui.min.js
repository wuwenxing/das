...
if($(ck).attr("name") !="customcheckbox"){
	if(ck.is(":checked")){
		_6a1(_6a0);
		}else{
		_6a2(_6a0);
...
var dc=_754.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox][name!=customcheckbox]");
...
// 增加清空
$(_b92).combo('setValue', '').combo('setText', '');
...
// 增加清空
$(_bb3).combo('setValue', '').combo('setText', '');
