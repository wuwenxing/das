...
var dasStatisticsReport = {
	...
	loadDataGrid : function(url,queryParams,reportType,dataGridId,pageSize,pageList){
		...
		$('#' + dataGridId).datagrid(easyui.defaultOption).datagrid({
			...
			frozenColumns:[[{field : fieldName, title : '日期', sortable : true, align:'center',width : 92}]],
			columns : columns,
			idField : 'rowKey', // 唯一字段
			sortName : '',
			sortOrder : 'desc',
			...
			rowStyler:function(rowIndex,rowData){  
				if(reportType == "days"){
					if(!common.isBlank(rowData.dateDay)){  
			        	...
			        	//	return 'background-color:#EED1D0;color:#fff;font-weight:bold;font-size:12px;'; 
			...
			onLoadSuccess : function(data){	
				if(reportType == "days"){
					$("div.datagrid-footer [class$='dateDay']").text("小计：");
				}
	...
	loadDataDailyChannel : function(){
		...
		var columns = [ 
			[
				...
				{field : "channel", title : '渠道', rowspan: 2, sortable : true, width : 120},
		...
		if(monthAllChecked && monthDeviceChecked && monthChannelChecked){
			var columns = [ 
			      			[
			   				...
			   				{field : 'devicehead', title : '设备类型', colspan: 15, sortable : false, align:'center',width : 750},
			   				{field : 'channelhead', title : '渠道', colspan: 15, sortable : false, align:'center',width : 750}
			   			],
			   			[
			   				{field : 'whole', title : '整站', colspan: 7, sortable : false, align:'center',width : 360},
			   				{field : 'pc', title : 'PC', colspan: 5, sortable : false,align:'center', width : 250},
			   				{field : 'android', title : 'Android', colspan: 5, sortable : false, align:'center',width : 250},
			   				{field : 'ios', title : 'IOS', colspan: 5, sortable : false, align:'center',width : 250},
			   				{field : 'pay', title : '付费', colspan: 5, sortable : false, align:'center',width : 250},
			   				{field : 'free', title : '免费', colspan: 5, sortable : false, align:'center',width : 250},
			   				{field : 'other', title : '其它', colspan: 5, sortable : false, align:'center',width : 250}
			   			],
			   		    [
			                ...
			                {field : 'channelPayVisit', title : '访问', sortable : true, width : 50},
			   	            {field : 'channelPayAdvisory', title : '咨询', sortable : true, width : 50},
			   	            {field : 'channelPayReal', title : '真实', sortable : true, width : 50},		     
			                {field : 'channelPayDemo', title : '模拟', sortable : true, width : 50},
			   	            {field : 'channelPayDeposit', title : '入金', sortable : true, width : 50},
			   	 			
			                {field : 'channelFreeVisit', title : '访问', sortable : true, width : 50},
			   	            {field : 'channelFreeAdvisory', title : '咨询', sortable : true, width : 50},
			   	            {field : 'channelFreeReal', title : '真实', sortable : true, width : 50},		     
			                {field : 'channelFreeDemo', title : '模拟', sortable : true, width : 50},
			   	            {field : 'channelFreeDeposit', title : '入金', sortable : true, width : 50},
			   	 			
			                {field : 'channelOtherVisit', title : '访问', sortable : true, width : 50},
			   	            {field : 'channelOtherAdvisory', title : '咨询', sortable : true, width : 50},
			   	            {field : 'channelOtherReal', title : '真实', sortable : true, width : 50},		     
			                {field : 'channelOtherDemo', title : '模拟', sortable : true, width : 50},
			   	            {field : 'channelOtherDeposit', title : '入金', sortable : true, width : 50}
			    			] ];
		  return columns;
		}
		...
		if(!monthAllChecked && !monthDeviceChecked && monthChannelChecked){
			var columns = [ 
			   		    ...
			   		    [			   	 			
			                ...
			                {field : 'channelOtherVisit', title : '访问', sortable : true, width : 50},
			   	            {field : 'channelOtherAdvisory', title : '咨询', sortable : true, width : 40},
			   	            {field : 'channelOtherReal', title : '真实', sortable : true, width : 50},		     
			                {field : 'channelOtherDemo', title : '模拟', sortable : true, width : 50},
			   	            {field : 'channelOtherDeposit', title : '入金', sortable : true, width : 50}
			    			] ];
