...
<script type="text/javascript" src="<%=basePath%>page/market/email/emailDetail.js?version=20170306"></script>
</head>
<body>
		...
		<form id="searchForm" class="searchForm" action="">
			<div>
				<table class="commonTable">
					<tr>
						<th>邮件ID</th>
						<td><input type="text" id="emailIdSearch" name="emailIdSearch" value="${emailId}" maxlength="50"/></td>
						<th>提交状态</th>
						<td>
					...
					<tr>
						<td colspan="8">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="emailDetail.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="emailDetail.reset();"
