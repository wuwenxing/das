...
<script type="text/javascript" src="<%=basePath%>page/report/dasFlowStatisticsMedia.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/report/dasFlowStatisticsMediaChart.js?version=20170306"></script>
</head>
<body>
					...
					<tr>
						<td colspan="6">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasFlowStatisticsMedia.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasFlowStatisticsMedia.reset();"
...
<div class="common-box-style">
	...
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasFlowStatisticsMedia.exportExcel();"
