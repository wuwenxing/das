...
<script type="text/javascript" src="<%=basePath%>page/operateStatistics/customerQuality/customerQualityClient.js?version=20170306"></script>
</head>
<body>
			...
			<div>
				<table class="commonTable">
					<tr>
						<th>统计周期</th>
						<td>
							<select id="reportTypeSearch" name="reportTypeSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false, onChange: function(newValue,oldValue){customerQualityClient.setDateboxAttr(newValue,oldValue)}">
					...
					<tr class="more">
						<th><input type="checkbox" id="platformVersionChecked" name="platformVersionChecked" value="false" onclick="if(checked==true) {value = 'true'; checked='checked';} else {value = 'false'; checked='';}"/>版本</th>
					...
					<tr>
						<td colspan="6">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="customerQualityClient.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="customerQualityClient.reset();"
...
<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="customerQualityClient.exportExcel();"
