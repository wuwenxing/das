$(function() {
	customerQualityWeb.init();
});

var customerQualityWeb = {
	dataGridId: "dataGrid",
	...
	init:function(){
		...
		customerQualityWeb.loadDataGrid();
	},
	/**
	 * 加载dataGrid
	 */
	loadDataGrid : function(){
		...
		$('#' + customerQualityWeb.dataGridId).datagrid(easyui.defaultOption).datagrid({
			url : url,
		    ...
		    onLoadSuccess : function(data){		    	
		    	customerQualityWeb.showColumn();		    	    		
		    	common.iFrameHeight();
		    }
		});
	},
	getQueryParams: function() {
		var options = $("#" + customerQualityWeb.dataGridId).datagrid('options');
	 ...
	 */
	find: function(){
		customerQualityWeb.getQueryParams();
		
		customerQualityWeb.showColumn();
		
		common.loadGrid(customerQualityWeb.dataGridId);
	},
	
	showColumn:function(){
		var reportType = $("#reportTypeSearch").combobox('getValue');
		if(reportType == 'days' || reportType == 'months'){
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'weeks');
		}
		if(reportType == 'weeks'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'weeks');
		}
		
		if($("#deviceTypeChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'deviceType');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'deviceType');
		}
		
		if($("#channelGroupChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'channelGrp');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'channelGrp');
		}
		
		if($("#channelLevelChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'channelLevel');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'channelLevel');
		}
		
		if($("#channelChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'channel');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'channel');
		}
		
		if($("#utmcsrChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'utmcsr');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'utmcsr');
		}
		
		if($("#utmcmdChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'utmcmd');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'utmcmd');
		}
		
		if($("#utmccnChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'utmccn');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'utmccn');
		}
		
		if($("#utmcctChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'utmcct');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'utmcct');
		}
		
		if($("#utmctrChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'utmctr');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'utmctr');
		}	
		
		if($("#landingPageChecked").val() == 'true'){
			$("#" + customerQualityWeb.dataGridId).datagrid('showColumn', 'landingPage');
		}else{
			$("#" + customerQualityWeb.dataGridId).datagrid('hideColumn', 'landingPage');
		}	
	},
	/**
	 * reset条件查询
	...
	reset: function(){
		...
		$('#' + customerQualityWeb.searchFormId).form('reset');
	...
	exportExcel : function(){
		...
		var queryParams = customerQualityWeb.getQueryParams();
