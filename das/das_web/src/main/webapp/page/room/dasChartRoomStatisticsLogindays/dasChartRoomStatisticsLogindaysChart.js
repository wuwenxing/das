...
var dasChartRoomStatisticsLogindaysChart = {
	/**
	 * 显示或隐藏load图标
	 */
	...
	findChartData : function() {
		...
		if (type == 1) {
			tab.panel('refresh', 'page/room/dasChartRoomStatisticsLogindays/statisticsLogindaysChart.html');
		}
	},
	/**
	 * 获取图表数据
	...
	loadChartData : function(type) {
		dasChartRoomStatisticsLogindaysChart.showOrHideLoadingDiv(type, true);
		
		// 获取表格数据
		var rows = $('#' + dasChartRoomStatisticsLogindays.dataGridId).datagrid('getRows');
		...
		// 显示图表
		dasChartRoomStatisticsLogindaysChart.showOrHideLoadingDiv(type, false);
		if (type == 1) {
			dasChartRoomStatisticsLogindaysChart.showChart1(dateTimeArray, u0Array, u1Array, u2Array, u3Array, u4Array, u5Array);
			dasChartRoomStatisticsLogindaysChart.showChart2(u0Array, u1Array, u2Array, u3Array, u4Array, u5Array);
		}
	},
	/**
	 * 显示图表
		...
		var	option = {
		    ...
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"直播间今日登录天数"}
		        }
		    },
		    legend: {
		...
		var	option = {
		    ...
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"直播间往日登录天数"}
		        }
		    },
		    series : [
		        {
