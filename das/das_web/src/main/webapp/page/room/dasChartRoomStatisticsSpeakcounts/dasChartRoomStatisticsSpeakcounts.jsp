...
<script type="text/javascript" src="<%=basePath%>page/room/dasChartRoomStatisticsSpeakcounts/dasChartRoomStatisticsSpeakcounts.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/room/dasChartRoomStatisticsSpeakcounts/dasChartRoomStatisticsSpeakcountsChart.js?version=20170306"></script>
</head>
<body>
			...
			<div>
				...
				<table class="commonTable">
					<tr>
						<th>统计周期</th>
						<td>
							<select id="reportTypeSearch" name="reportTypeSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false, onChange: function(newValue,oldValue){dasChartRoomStatisticsSpeakcounts.setDateboxAttr(newValue,oldValue)}">
					...
					<tr>
						<td colspan="8">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakcounts.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakcounts.reset();"
...
<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakcounts.exportExcel();"
