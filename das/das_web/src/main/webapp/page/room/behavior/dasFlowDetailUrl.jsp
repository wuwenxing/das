...
<script type="text/javascript" src="<%=basePath%>page/room/behavior/dasFlowDetailUrl.js?version=20170306"></script>
</head>
<body>
					...
					<tr>
					    ...
					    <td class="more">
						   <select id="devicetypeSearch" name="devicetypeSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false">
							  ...
							  <das:enumListTag defaultVal="${devicetype}" dataList="${clientEnum}"/>
						   </select>
					    </td>
