...
<script type="text/javascript" src="<%=basePath%>page/room/dasChartRoomStatisticsSpeakdays/dasChartRoomStatisticsSpeakdays.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/room/dasChartRoomStatisticsSpeakdays/dasChartRoomStatisticsSpeakdaysChart.js?version=20170306"></script>
</head>
<body>
			...
			<div>
				<table class="commonTable">
					<tr>
						<th>日期</th>
						<td>
							<input class="easyui-datebox" type="text" name="startTimeSearch" id="startTimeSearch" data-options="required:false, editable:false,formatter:easyui.formatterYYYYMM,parser:easyui.parserYYYYMM" value="<das:date type="lessOneYears" format="yyyy-MM"/>"/>
							至
							<input class="easyui-datebox" type="text" name="endTimeSearch" id="endTimeSearch" data-options="required:false, editable:false,formatter:easyui.formatterYYYYMM,parser:easyui.parserYYYYMM" value="<das:date type="monthEnd" format="yyyy-MM"/>"/>
						</td>
					...
					<tr class="more">
						<th>发言类型</th>
						<td>
							<select id="speakTypeSearch" name="speakTypeSearch" class="easyui-combobox" data-options="panelHeight:'auto', editable:false">
								<option value="">---请选择---</option>
								<das:enumListTag dataList="${roomSpeakTypeEnum}"/>
							</select>
						</td>
						<th>用户来源</th>
					...
					<tr>
						<td colspan="8">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakdays.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakdays.reset();"
...
<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartRoomStatisticsSpeakdays.exportExcel();"
