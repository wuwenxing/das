...
<script type="text/javascript" src="<%=basePath%>page/room/dasChartRoomStatisticsBehaviorCount/dasChartStatisticsAverage.js?version=20170306"></script>
</head>
<body>
					...
					<tr>
						<td colspan="8">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartStatisticsAverage.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartStatisticsAverage.reset();"
...
<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dasChartStatisticsAverage.exportExcel();"
