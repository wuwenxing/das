...
var dasChartRoomStatisticsVisitcountsChart = {
	/**
	 * 显示或隐藏load图标
	 */
	...
	findChartData : function() {
		var tab = $('#dasChartRoomStatisticsVisitcountsChartTabs').tabs('getSelected');
		var type = $('#dasChartRoomStatisticsVisitcountsChartTabs').tabs('getTabIndex', tab);
		if (type == 1) {
			tab.panel('refresh', 'page/room/dasChartRoomStatisticsVisitcounts/statisticsVisitcountsChart.html');
		}
	},
	/**
	 * 获取图表数据
	...
	loadChartData : function(type) {
		dasChartRoomStatisticsVisitcountsChart.showOrHideLoadingDiv(type, true);
		
		// 获取表格数据
		var rows = $('#' + dasChartRoomStatisticsVisitcounts.dataGridId).datagrid('getRows');
		...
		// 显示图表
		dasChartRoomStatisticsVisitcountsChart.showOrHideLoadingDiv(type, false);
		if (type == 1) {
			dasChartRoomStatisticsVisitcountsChart.showChart1(dateTimeArray, u1Array, u2Array, u3Array, u4Array, u5Array, u6Array);
			dasChartRoomStatisticsVisitcountsChart.showChart2(u1Array, u2Array, u3Array, u4Array, u5Array, u6Array);
		}
	},
	/**
	 * 显示图表
		...
		var	option = {
		    ...
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"直播间今日访问次数"}
		        }
		    },
		    legend: {
		...
		var	option = {
		    ...
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"直播间往日访问次数"}
		        }
		    },
		    series : [
		        {
