...
var p_2_14 = {
	...
	init:function(){
		...
		$.ajax({
		    ...
		    beforeSend: function(XMLHttpRequest){
		    	...
		    	common.addOrRemoveLoading('p_2_14', true);
		    },
			success : function(rows) {
		    	common.addOrRemoveLoading('p_2_14', false);
				...
				p_2_14.showChart(exectimeArray, companyprofitArray);
			},
			error: function(data){
				common.error();
	        }
	...
	showChart : function (exectimeArray, companyprofitArray){
        var myChart = echarts.init(document.getElementById('dealprofithourStatisticsChartContainer_2_14'), 'shine');
		var	option = {
		    tooltip: {
		        trigger: 'axis'
		    },
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"MT5净盈亏图"}
		        }
		    },
		    legend: {
		        width: '450',
