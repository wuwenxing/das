...
var p_2_9 = {
	...
	init:function(){
		...
		$.ajax({
		    ...
		    beforeSend: function(XMLHttpRequest){
		    	...
		    	common.addOrRemoveLoading('p_2_9', true);
		    },
			success : function(rows) {
		    	common.addOrRemoveLoading('p_2_9', false);
				...
				p_2_9.showChart(exectimeArray, companyprofitArray);
			},
			error: function(data){
				common.error();
	        }
	...
	showChart : function (exectimeArray, companyprofitArray){
        var myChart = echarts.init(document.getElementById('dealprofithourStatisticsChartContainer_9'), 'shine');
		var	option = {
		    tooltip: {
		        trigger: 'axis'
		    },
		    toolbox: {
		        ...
		        feature: {
		            ...
		            restore: {show: false},
		            saveAsImage: {show: true,name:"GTS2净盈亏图"}
		        }
		    },
		    legend: {
		        width: '450',
