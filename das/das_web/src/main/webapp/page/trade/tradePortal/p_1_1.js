 ...
 */
var p_1_1 = {
	dataGridId : "dataGrid_1_1",
	loadDataGridFlag : false,
	/**
	 * 初始化
	 */
	init : function() {
		if (p_1_1.loadDataGridFlag) {
			p_1_1.find();
		} else {
			p_1_1.loadDataGridFlag = true;
			p_1_1.loadDataGrid();
		}
	},
	/**
	...
	loadDataGrid : function() {
		...
		$('#' + p_1_1.dataGridId).datagrid(easyui.defaultOption).datagrid({
			url : url,
	...
	getQueryParams : function() {
		var options = $("#" + p_1_1.dataGridId).datagrid('options');
	 ...
	 */
	find : function() {
		p_1_1.getQueryParams();
		common.loadGrid(p_1_1.dataGridId);
	}
}