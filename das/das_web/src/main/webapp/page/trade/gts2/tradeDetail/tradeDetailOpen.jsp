...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/tradeDetail/tradeDetailOpen.js?version=20170306"></script>
</head>
<body>
					...
					<tr>
						<td colspan="4">
							<div class="searchButton">
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="tradeDetailOpen.find();"
									data-options="iconCls:'icon-search', plain:'true'">查询</a>
								<a href="javascript:void(0);" class="easyui-linkbutton" onclick="tradeDetailOpen.reset();"
...
<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="tradeDetailOpen.exportExcel();"
