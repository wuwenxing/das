...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/companyequitymdeposit/companyequitymdepositStatistics.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/companyequitymdeposit/companyequitymdepositStatisticsChart.js?version=20170306"></script>
</head>
<body>
				...
				<tr>
					<td colspan="4">
						<div class="searchButton">
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="companyequitymdepositStatistics.find();"
								data-options="iconCls:'icon-search', plain:'true'">查询</a>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="companyequitymdepositStatistics.reset();"
...
<div class="common-box-style">
	<div class="divTitle">净入金</div>
	<div class="divContent">
		<div class="companyequitymdepositStatisticsDiv" style="padding:15px;"><img src = "<%=basePath%>img/icons/loading.gif" style="vertical-align: middle; padding-right: 5px;"/>正在处理，请稍待。。。</div>
		<div id="companyequitymdepositstatisticsChartContainer" style="min-width: 600px; min-height: 400px; margin: 0 auto"></div>
	</div>
</div>

<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="companyequitymdepositStatistics.exportExcel();"
