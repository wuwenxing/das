...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dailyreport/dailyreportStatistics.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dailyreport/dailyreportStatisticsChart.js?version=20170306"></script>
</head>
<body>
				...
				<tr>
					<td colspan="4">
						<div class="searchButton">
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dailyreportStatistics.find();"
								data-options="iconCls:'icon-search', plain:'true'">查询</a>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dailyreportStatistics.reset();"
...
<div class="common-box-style">
	...
	<div class="divContent">
		<div class="dailyreportStatisticsDiv" style="padding:15px;"><img src = "<%=basePath%>img/icons/loading.gif" style="vertical-align: middle; padding-right: 5px;"/>正在处理，请稍待。。。</div>
		<div id="dailyreportstatisticsChartContainer" style="min-width: 600px; min-height: 400px; margin: 0 auto"></div>
	</div>
</div>

<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dailyreportStatistics.exportExcel();"
