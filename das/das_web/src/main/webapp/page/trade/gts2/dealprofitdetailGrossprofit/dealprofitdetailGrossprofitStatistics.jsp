...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dealprofitdetailGrossprofit/dealprofitdetailGrossprofitStatistics.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dealprofitdetailGrossprofit/dealprofitdetailGrossprofitStatisticsChart.js?version=20170306"></script>
</head>
<body>
				...
				<tr>
					<td colspan="4">
						<div class="searchButton">
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealprofitdetailGrossprofitStatistics.find();"
								data-options="iconCls:'icon-search', plain:'true'">查询</a>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealprofitdetailGrossprofitStatistics.reset();"
...
<div class="common-box-style">
	<div class="divTitle">毛利</div>
	<div class="divContent">
		<div class="dealprofitdetailGrossprofitStatisticsDiv" style="padding:15px;"><img src = "<%=basePath%>img/icons/loading.gif" style="vertical-align: middle; padding-right: 5px;"/>正在处理，请稍待。。。</div>
		<div id="dealprofitdetailGrossprofitStatisticsChartContainer" style="min-width: 600px; min-height: 400px; margin: 0 auto"></div>
	</div>
</div>

<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealprofitdetailGrossprofitStatistics.exportExcel();"
