...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dealchannel/dealchannelStatistics.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/dealchannel/dealchannelStatisticsChart.js?version=20170306"></script>
</head>
<body>
				...
				<tr>
					<td colspan="4">
						<div class="searchButton">
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealchannelStatistics.find();"
								data-options="iconCls:'icon-search', plain:'true'">查询</a>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealchannelStatistics.reset();"
...
<div class="common-box-style">
	<div class="divTitle">下单途径比例</div>
	<div class="divContent">
		<div class="dealchannelStatisticsDiv" style="padding:15px;"><img src = "<%=basePath%>img/icons/loading.gif" style="vertical-align: middle; padding-right: 5px;"/>正在处理，请稍待。。。</div>
		<div id="dealchannelStatisticsChartContainer" style="min-width: 600px; min-height: 400px; margin: 0 auto"></div>
	</div>
</div>

<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="dealchannelStatistics.exportExcel();"
