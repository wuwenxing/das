...
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/accountchannel/accountchannelStatistics.js?version=20170306"></script>
<script type="text/javascript" src="<%=basePath%>page/trade/gts2/accountchannel/accountchannelStatisticsChart.js?version=20170306"></script>
</head>
<body>
...
<div class="common-box-style">
	<div class="divContent">
		<form id="searchForm" class="searchForm" action="">
		    <input type="hidden" id="accountchannelType" name="accountchannelType" value="${accountchannelType}">
				...
				<tr>
					<td colspan="4">
						<div class="searchButton">
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="accountchannelStatistics.find();"
								data-options="iconCls:'icon-search', plain:'true'">查询</a>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="accountchannelStatistics.reset();"
...
<div class="common-box-style">
	<div class="divTitle">新开户/激活途径比例</div>
	<div class="divContent">
		<div class="accountchannelStatisticsDiv" style="padding:15px;"><img src = "<%=basePath%>img/icons/loading.gif" style="vertical-align: middle; padding-right: 5px;"/>正在处理，请稍待。。。</div>
		<div id="accountchannelStatisticsChartContainer" style="min-width: 600px; min-height: 400px; margin: 0 auto"></div>
	</div>
</div>

<div class="common-box-style">
	<div id="toolbar">
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="accountchannelStatistics.exportExcel();"
