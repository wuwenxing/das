...
public class DasStatisticsReport
{
	...
	//新客有效咨询数
	private int newCustConsultation;
	
	//老客有效咨询数
	private int oldCustConsultation;
	...
	public int getNewCustConsultation()
	{
		return newCustConsultation;
	}


	
	public void setNewCustConsultation(int newCustConsultation)
	{
		this.newCustConsultation = newCustConsultation;
	}


	
	public int getOldCustConsultation()
	{
		return oldCustConsultation;
	}


	
	public void setOldCustConsultation(int oldCustConsultation)
	{
		this.oldCustConsultation = oldCustConsultation;
	}
