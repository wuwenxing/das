...
public class DasChartFlowStatisticsTreeMedia{
	...
	private List<DasChartFlowStatisticsTreeMedia> children;
	...
	public List<DasChartFlowStatisticsTreeMedia> getChildren() {
		return children;
	}


	public void setChildren(List<DasChartFlowStatisticsTreeMedia> children) {
	...
	{
		DasChartFlowStatisticsTreeMedia mediaBean = (DasChartFlowStatisticsTreeMedia) obj;
