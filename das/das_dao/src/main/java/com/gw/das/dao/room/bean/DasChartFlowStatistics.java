...
public class DasChartFlowStatistics {
	...
	/** 子字典 */
	private List<DasChartFlowStatistics> children = new ArrayList<DasChartFlowStatistics>();
	...
	public List<DasChartFlowStatistics> getChildren() {
		return children;
	}

	public void setChildren(List<DasChartFlowStatistics> children) {
