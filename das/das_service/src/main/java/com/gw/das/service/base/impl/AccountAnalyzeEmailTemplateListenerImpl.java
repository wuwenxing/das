 ...
 */
@Service
public class AccountAnalyzeEmailTemplateListenerImpl implements EmailListener{

	private static final Logger logger = LoggerFactory.getLogger(AccountAnalyzeEmailTemplateListenerImpl.class);
