 ...
 */
@Repository
public class DasChartRoomStatisticsLogindaysDao extends ReportDao {
	...
	public <T extends BaseSearchModel> void getPubParam(StringBuffer sql, T t, List<Object> paramList){
		...
		sql.append("a.u0,a.u1,a.u2,a.u3,a.u4,a.u5,a.u6,");
		sql.append("a.businessplatform");
		sql.append(" FROM das_chart_room_logindays_statistics_months a ");
