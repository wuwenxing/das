package com.gw.das.common.hxapi;
...
public class HxSidCache {
	 ...
	 */
	static {
		hxApiUrl = SystemConfigUtil.getProperty(SystemConfigEnum.hxApiUrl);
		hxApiUsername = SystemConfigUtil.getProperty(SystemConfigEnum.hxApiUsername);
		hxApiPassword = SystemConfigUtil.getProperty(SystemConfigEnum.hxApiPassword);
	}
